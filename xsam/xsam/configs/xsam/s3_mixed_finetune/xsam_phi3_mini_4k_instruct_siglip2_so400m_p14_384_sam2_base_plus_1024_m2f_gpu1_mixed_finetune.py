...
# 1) Segmentor encoder + bridge + m2f decoder from Stage1
# 2) visual/seg projectors from Stage2 (projector-only file)
...
bash run.sh --modes train \
  --config xsam/xsam/configs/xsam/s3_mixed_finetune/xsam_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam2_base_plus_1024_m2f_gpu1_mixed_finetune.py
