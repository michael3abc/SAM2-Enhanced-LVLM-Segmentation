...
_projector_pretrained_candidates = [
    work_dir
    ...
    work_dir
    + "s2_align_pretrain/xsam_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam2_base_plus_1024_m2f_gpu2_mixed_finetune_v2/pytorch_model.bin",
    work_dir + "s2_align_pretrain/xsam_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam2_base_e1_gpu1_align_pretrain_768/pytorch_model.bin",
]
projector_pretrained_pth = _projector_pretrained_candidates[0]
for _cand in _projector_pretrained_candidates:
    if __import__("os").path.exists(_cand):
        projector_pretrained_pth = _cand
        break
...
# Scheduler & Optimizer
batch_size = 8  # per_device (single GPU)
accumulative_counts = 16 # global batch ~= 4
...
bash run.sh --modes train \
  --config xsam/xsam/configs/xsam/s3_mixed_finetune/sam2/xsam_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam2_base_plus_1024_m2f_gpu1_mixed_finetune.py
