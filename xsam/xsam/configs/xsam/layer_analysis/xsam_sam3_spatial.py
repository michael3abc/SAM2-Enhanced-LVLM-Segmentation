...
from external.sam3.layer_analysis.sweep_cfg import SaptialSweepCfg
...
# Spatial layer sweep config (used by external/sam3/layer_analysis/sweep_L_spatial.py).
sweep_spatial_cfg = SaptialSweepCfg(
    config="",
    pth_model=None,
